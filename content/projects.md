...
### NYC Taxi Trip Data Analysis - [Github](https://github.com/AADARSH96/nyc-trip-data-snowflake-analysis)
Developed a data analysis project using Snowflake and Snowpark to process and analyze NYC taxi trip data. Set up a database, automated data ingestion from S3, and optimized query performance using clustering keys and search optimization. Performed key analyses, including revenue by payment type and busiest pickup locations, leveraging Snowflake's scalability and Snowpark's Python integration for efficient data processing.
